...
// current prize becomes the new king. On such an event, the overthrown king gets paid the new prize, making a bit 
// of ether in the process! As ponzi as it gets xD
